<template>
  ...
  <div class="role_list">
    ...
    <el-dialog title="授权" :visible.sync="authorization_visible">
      <el-form :model="role">
        {{role}}
        <el-form-item label="角色名称" label-width="80px"></el-form-item>
        
        <el-form-item label="权限" label-width="80px">
          <el-cascader v-model="role.privileges" :options="options" :props="props" clearable>
        </el-cascader>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="authorizationCancel" size="small">取 消</el-button>
